...
[![GoDoc](https://godoc.org/github.com/conseweb/stcwallet/walletdb?status.png)]
(http://godoc.org/github.com/conseweb/stcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/conseweb/stcwallet/walletdb

## Installation

```bash
$ go get github.com/conseweb/stcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/conseweb/stcwallet/walletdb#example-package--BasicUsage)  
